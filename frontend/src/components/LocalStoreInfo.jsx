...
export const LocalStoreInfo = () => {
  ...
  return <section className="local-store-info" aria-labelledby="local-store-heading">
    <div><p className="eyebrow" data-testid="local-store-area"><MapPin size={14}/>{city}, {region}</p><h2 id="local-store-heading" data-testid="local-store-heading"> Laptops in {city}.</h2></div>
