...
export const LocalStoreInfo = () => {
  ...
  return <section className="local-store-info" aria-labelledby="local-store-heading">
    ...
    <div><p data-testid="local-store-description">Shop second-hand and refurbished laptops at <strong>{settings.store_name}</strong> in {city}, {region}. Compare specifications, condition and prices, then order online.</p>
